...
curl -s -X PUT -H "Content-Type: application/json" -H "Authorization: Bearer $ADMIN_TOKEN" -d '{"phone": "+1-555-019-8888"}' $BASE_URL/api/platform/clinics/clinic_apex_101 > /dev/null
echo "Updated phone."
echo -e "\n"

echo "5. Compile (After Change / Versioning Test):"
